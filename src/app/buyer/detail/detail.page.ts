  ...
  share() {
    if (window.navigator['share']) {
      window.navigator['share']({
        title: '土产大集',
        text: '[土产大集]上土产大集，让乡货便宜到家--' + this.commodity.title,
      ...
      aux.setAttribute("value", "[土产大集]上土产大集，让乡货便宜到家--" + this.commodity.title + ";https://iyou.city/commodity/detail?id=" + this.commodity.id);
    ...
    this.wechat.share({
      message: {
        title: "[土产大集]上土产大集，让乡货便宜到家--" + this.commodity.title,
